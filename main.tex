...
das Halten eines Tutoriums in meinen Aufgabenbereich, in der ich die Vorlesungsinhalte der vergangengen
Woche und jeweils die Korrektur des vorangegangenen Übungsblattes und eine Vorbesprechung des aktuell zu
bearbeitenden Übungsblattes. Dabei sollte ich die Vorlesungsinhalte auf eine neue Art und an die jeweiligen
...
und beratend zur Seite stehen. Ich hatte eine feste Gruppe aus ca. 20 Studierenden, die zu meiner Übungsgruppe
...
Vorlesung und die jeweils aktuellen Übungsblätter informierte. Einen sehr großen Teil dieser Tätigkeiten sollte
...
einer eigens für eine ungezwungene Kommunikation eingerichtete Whatsapp-Gruppe zu kontaktieren. 
...
ging Regelmäßig mit ihr in die Mensa zum Essen oder traf sie im Kontext der gemeinsamen Freundesgruppe regelmäßig.
...
herum war der einzige Einfluss, dass ich ihren Namen bereits kannte und wir häufig nach den Tutorien gemeinsam essen
...
die immer diesselbe Handschrift hatte, dachte mir nichts dabei. Nach ein paar Monaten eröffnete mir E., dass sie mit
ihrer Abgabegruppe nicht zufrieden sei, da sich T. und D. als sehr unzuverlässig erwiesen. Sie wies mich nach Anfrage
an, nichts zu unternehmen. Einige Wochen später sprachen wir erneut über die Vorlesung und sie erzählte mir von ihren Plänen,
den Studiengang zu wechseln, da sie sich darin nicht so wohl fühle. Zu diesem Zeitpunkt waren bereits ein Großteil der
Übungsblätter abgegeben worden. Nach ihrem Abbruch hörte die Abgabegruppe, die immer die selbe Handschrift aufwies, auf,
regelmäßig Abgaben einzureichen. Sie haben die Klausurzulassung nicht erreicht.
...
Fehlern, die in der Informatik korrekt waren, aber in einem falschen Format, also zum Beispiel durch Komprimierung
unleserliche Dokumente oder falsche Dateinamen. Einige Fehler waren irgendwo in der Mitte, dort habe ich im Einzelfall
entschieden. Bei Abgabegruppen, die knapp an der Grenze zum Bestehen lagen, habe ich auf Anfrage kurz vor Ende des
Semesters Punkte, die ich für Formalitäten abgezogen hatte, wieder gutgeschrieben, um die Zulassung nicht wegen für
den späteren Berufsalltag irrelevanter Formalitäten zu gefährden oder gar um ein Semester zu verzögern. Das habe ich
während des Praktikumszeitraums bei einer anderen Abgabegruppe gemacht und diese Option öffentlich beworben.

\subsection{Klausurzulassungsanfrage}
Einige Wochen nach der ersten Klausur schrieb mir T. in Absprache mit D. eine Mail, in der sie E. als unzuverlässig
darstellten und damit begründen wollten, warum die Klausurzulassung von ihnen nicht erreicht werden konnte. Ich habe
mir die Bepunktungen angeschaut und festgestellt, dass sie in meinem normalen Vorgehen, die Formalitätspunkte wieder
gutzuschreiben, die Zulassung um wenige Punkte verfehlten. Außerdem war die Klausurzulassung bereits am Ende des Semesters
abgeschlossen worden, was auf jeden Fall eine Kommunikation mit dem zuständigen Professor notwenig machen würde.
...
zuständig war und schilderte ihm die Situation. Ich gab an, dass ich mit E. befreundet war und habe beide Sichtweisen geschildert.
Außerdem bat ich E. darum, eine Schriftprobe abzugeben.

Die Ansprechperson hat daraufhin entschieden, T. und D. keine Klausurzulassung zu erteilen, was ich in einer Antwortmail
an T. mitteilte. Ein Handschriftenabgleich wurde nicht durchgeführt.

\section{Reflexion des Falls}
Reflexion des Falls als Krise, Irritation, Widerspruch...(ca. 2,5 Seiten)\todo{entfernen}\\
\begin{itemize}
    \item erkenntnisorientierter Typus
    \begin{itemize}
        \item Anspruch der Reflexivität
    \end{itemize}
    \item problemlösungsorientierter Typus
    \begin{itemize}
        \item Fall als Problem, wie lässt sich das bearbeiten
        \item Warum war das für mich ein Problem?
        \item Warum ist diese spezielle Lösung gut für mich?
        \item Was wären alternative Lösungen?
        \item (Trotzdem Anspruch der Reflexivität kp)
    \end{itemize}
\end{itemize}
\todo[inline]{Modus der Fallbeschreibung aussuchen, abh. von der Funktion}
\todo[inline]{Systematisierungsdimensionen aussuchen}
...
Die Begründungsantinomie beschreibt ein Spannungsfeld zwischen den Ansprüchen an didaktische Kräfte, ihre Handlungen begründen
zu können und trotzdem spontan und flexibal auf Situationen bzw. Irritationen reagieren zu können. In meinem Fall war zwar eine
begründete Handlung angesagt, durch die Form der Anfrage, eine Mail, blieb mir aber genügend Zeit, um die Situation zu evaluieren
und Rücksprache zu halten. Wäre die Situation in einem Gespräch, gegebenenfalls 
